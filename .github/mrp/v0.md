...
| cline        | supported       | supported     | experimental          | experimental          | experimental          |
...
**Cline** is a VSCode extension with different hook semantics. Session boundaries are
detectable; turn-level and compact/clear events require heuristic detection.
